...
* simplify ui update logic ([0aa6dc6](https://github.com/local-group-games/warbird/commit/0aa6dc6))
...
* sync player ship stats ([c0ce184](https://github.com/local-group-games/warbird/commit/c0ce184))
...
**Note:** Version bump only for package warbird
...
* add Entity.tryGetComponent and update docs ([7c6b645](https://github.com/3mcd/colyseus-test/commit/7c6b645))
...
* check for player ship before handling PlaceTile ([7c6a199](https://github.com/3mcd/colyseus-test/commit/7c6a199))


### Features

* **ecs:** convert game logic to ECS pattern ([2155c3d](https://github.com/3mcd/colyseus-test/commit/2155c3d))
...
* add starfield background ([445f59f](https://github.com/3mcd/colyseus-test/commit/445f59f))
...
* use absolute value for thrust energy cost ([1f9f572](https://github.com/3mcd/colyseus-test/commit/1f9f572))
